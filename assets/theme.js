...
theme.Cart = (function() {
  ...
  function Cart() {
    ...
    $(selectors.cartNoteAdd).on('click', function() {
...
$(document).ready(function() {
  ...
  $('.accordion-list > li').click(function() {
    if ($(this).hasClass("active")) {
      $(this).removeClass("active").find(".answer").slideUp('fast');
    } else {
     // $(".accordion-list > li.active .answer").slideUp('fast');
      //$(".accordion-list > li.active").removeClass("active");      
      $(this).addClass("active").find(".answer").slideDown('fast');
    }
    return false;
  });
